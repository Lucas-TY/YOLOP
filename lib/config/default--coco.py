...
_C.DATASET.DATAROOT = '/fs/ess/scratch/PAS2119/OSCCompetition/wu.4355/bdd/coco/images/'       # the path of images folder
_C.DATASET.LABELROOT = '/fs/ess/scratch/PAS2119/OSCCompetition/wu.4355/bdd/coco/labels/'     # the path of det_annotations folder
_C.DATASET.MASKROOT = '/fs/ess/scratch/PAS2119/OSCCompetition/wu.4355/bdd/coco_seg_gt'                # the path of da_seg_annotations folder
_C.DATASET.LANEROOT = '/fs/ess/scratch/PAS2119/OSCCompetition/wu.4355/bdd/coco_lane_gt'               # the path of ll_seg_annotations folder
...
_C.TEST.PLOTS = True
_C.TEST.NMS_CONF_THRESHOLD  = 0.01
