...
# funk
_C.DATASET = CN(new_allowed=True)
_C.DATASET.DATAROOT = '/home/lucas/bdd/coco/images/'       # the path of images folder
_C.DATASET.LABELROOT = '/home/lucas/bdd/coco/labels/'     # the path of det_annotations folder
_C.DATASET.MASKROOT = '/home/lucas/bdd/coco_seg_gt'                # the path of da_seg_annotations folder
_C.DATASET.LANEROOT = '/home/lucas/bdd/coco_lane_gt'               # the path of ll_seg_annotations folder
_C.DATASET.DATASET = 'BddDataset'
_C.DATASET.TRAIN_SET = 'train_test'
_C.DATASET.TEST_SET = 'val_test'
_C.DATASET.DATA_FORMAT = 'jpg'
